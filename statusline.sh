...
# Resolve this script's directory (works even via symlink)
extras_dir="$(cd "$(dirname "$0")" && pwd)"

# Find latest claude-hud version (if installed)
