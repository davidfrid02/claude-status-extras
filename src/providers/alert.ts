...
export function parseAlerts(json: string, city: string): AlertData | null {
  try {
    const alerts = JSON.parse(json) as OrefAlert[];
...
export function fetchAlertSync(city: string): AlertData | null {
  try {
